...
<div class="container">
    <section id="dashboard">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="title"><h2>Editar Sitio de limpieza</h2></div>
                </div>
                <div class="col-md-4">
...
@component('components.city_selector',['selected_city_id' => $location->city_id]) @endcomponent
...
<div class="form-group">
    ...
    <div class="control">
        <input name="address_street_name"
          ...
          required
          value="{{$location->address_street_name}}"
        />
...
<div class="form-group">
    ...
    <div class="control">
        <input name="address_street_number"
          ...
          required
          value="{{$location->address_street_number}}"
        />
...
<div class="form-group">
    ...
    <label class="label text-black" for ="address_appartment">Departamento</label>
        ...
        <input name="address_appartment"
          ...
          value="{{$location->address_appartment}}"
        />
...
<div class="form-group">
    ...
    <div class="control">
        <input name="local_contact_name"
          ...
          required
          value="{{$location->local_contact_name}}"
        />
    ...
    <div class="control">
        <select name='supervisor_id'>
            ...
            <option value="{{$user->id}}"
                    @if($location->supervisor_id == $user->id) SELECTED @endif
                    >
